...
public class ThymeleafController {
    ...
    public ResponseEntity<String> getMockJWT(Model model, @PathVariable("username") String username, @PathVariable("link") String link, HttpServletRequest request ) throws org.json.simple.parser.ParseException, InterruptedException {
    ...
    public ResponseEntity<String> PostMockJWT(Model model, @PathVariable("username") String username, @PathVariable("link") String link, HttpServletRequest request) throws org.json.simple.parser.ParseException, InterruptedException {
    ...
    public ResponseEntity<String> putMockJWT(Model model, @PathVariable("username") String username, @PathVariable("link") String link, HttpServletRequest request ) throws org.json.simple.parser.ParseException, InterruptedException {
    ...
    public ResponseEntity<String> deleteMockJWT(Model model, @PathVariable("username") String username, @PathVariable("link") String link, HttpServletRequest request ) throws org.json.simple.parser.ParseException, InterruptedException {
    ...
    public ResponseEntity<String> patchMockJWT(Model model, @PathVariable("username") String username, @PathVariable("link") String link, HttpServletRequest request ) throws org.json.simple.parser.ParseException, InterruptedException {
    ...
    public ResponseEntity<String> optionsMockJWT(Model model, @PathVariable("username") String username, @PathVariable("link") String link, HttpServletRequest request ) throws org.json.simple.parser.ParseException, InterruptedException {
    ...
    @PostMapping("/auth/{id}")
    public void auth(@PathVariable("id") long id, HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, ParseException {
        String token = "";
    ...
    public ResponseEntity<?> authenticateForPostman(@PathVariable("id") long id) throws Exception{
        ...
        System.out.println("TOKEN CREADO CORRECTAMENTE");
        String body = "{\"SecretKey\": \""+token+"\", \"MethodAc\": \""+mock.getAccessMethod()+"\", \"URLAc\": \""+mock.getURL()+"\"}";
