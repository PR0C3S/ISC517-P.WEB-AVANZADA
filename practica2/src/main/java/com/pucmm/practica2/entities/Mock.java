...
public class Mock implements Serializable {
    ...
    private URI URL;
    private HttpMethod accessMethod;
...
//    {
//        HttpHeaders act = new HttpHeaders();
//
//        for (var entry : listaHeaders.entrySet()) {
//            act.add(entry.getKey(),entry.getValue());
//        }
//
//        return act;
//    }
    ...
    public void SETURL(String user) throws URISyntaxException {
        URL = new URI("http://localhost:8080/practica2/mock/"+user+"/view/"+endPoint);
    }
